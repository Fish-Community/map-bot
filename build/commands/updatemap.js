...
export async function updateMap(interaction) {
...
export const updateMapCommand = new SlashCommandBuilder()
    ...
    .addStringOption(option => option.setName('filename').setDescription('filename of the map you wish to replace').setRequired(true));
